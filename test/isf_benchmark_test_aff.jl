...
options_0_s = Options(0, 0, false, HiGHS.Optimizer, false, true, 0, false, true, 100000*eps(), 1000*eps(), Float64[], false, true, true)
options_1_s = Options(1, 0, false, HiGHS.Optimizer, false, true, 0, false, true, 100000*eps(), 1000*eps(), Float64[], false, true, true)
options_2_s = Options(2, 0, true, HiGHS.Optimizer, false, true, 0, false, true, 100000*eps(), 1000*eps(), Float64[], false, true, true)
options_3_s = Options(3, 3, true, HiGHS.Optimizer, false, true, 0, false, true, 100000*eps(), 1000*eps(), Float64[], false, true, true)
options_4_s = Options(4, 3, true, HiGHS.Optimizer, false, true, 1, false, true, 100000*eps(), 1000*eps(), Float64[], false, true, true)
options_4r_s = Options(4, 3, true, HiGHS.Optimizer, false, true, 1, true, true, 100000*eps(), 1000*eps(), Float64[], false, true, true)    # unused, no recursive covering when very few stem vectors 
options_5_s = Options(5, 3, true, HiGHS.Optimizer, false, true, 2, false, true, 100000*eps(), 1000*eps(), Float64[], false, true, true)
options_5r_s = Options(5, 3, true, HiGHS.Optimizer, false, true, 2, true, true, 100000*eps(), 1000*eps(), Float64[], false, true, true)    # unused, no recursive covering when very few stem vectors 
options_6_s = Options(6, 3, true, HiGHS.Optimizer, false, true, 3, false, true, 100000*eps(), 1000*eps(), Float64[], false, true, true)    # w often faster
options_6r_s = Options(6, 3, true, HiGHS.Optimizer, false, true, 3, true, true, 100000*eps(), 1000*eps(), Float64[], false, true, true)    # w often faster
options_6w_s = Options(6, 3, true, HiGHS.Optimizer, false, true, 3, false, true, 100000*eps(), 1000*eps(), Float64[], true, true, true)
options_6wr_s = Options(6, 3, true, HiGHS.Optimizer, false, true, 3, true, true, 100000*eps(), 1000*eps(), Float64[], true, true, true)
options_7_s = Options(7, 0, false, HiGHS.Optimizer, false, true, 3, false, true, 100000*eps(), 1000*eps(), Float64[], false, true, false)  # w often faster
options_7r_s = Options(7, 0, false, HiGHS.Optimizer, false, true, 3, true, true, 100000*eps(), 1000*eps(), Float64[], false, true, false)  # w often faster
options_7w_s = Options(7, 0, false, HiGHS.Optimizer, false, true, 3, false, true, 100000*eps(), 1000*eps(), Float64[], true, true, false)
options_7wr_s = Options(7, 0, false, HiGHS.Optimizer, false, true, 3, true, true, 100000*eps(), 1000*eps(), Float64[], true, true, false)

options_l = Options(7, 0, false, HiGHS.Optimizer, false, true, 4, true, false, 100000*eps(), 1000*eps(), Float64[], true, true, false)    # no tree structure
