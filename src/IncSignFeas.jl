...
# using Gurobi                            # Gurobi solver # in Project.toml Gurobi = "2e9cd046-0924-5485-92f1-d5272153d98b"
...
# const GUROBI_ENV = Gurobi.Env() # for Gurobi usage, removed for the Package version due to licensing issues. 
